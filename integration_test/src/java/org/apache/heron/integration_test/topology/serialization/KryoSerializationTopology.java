...
public final class KryoSerializationTopology extends AbstractTestTopology {
  ...
  private KryoSerializationTopology(String[] args) throws MalformedURLException {
    super(args);
  }
  ...
  protected TestTopologyBuilder buildTopology(TestTopologyBuilder builder) {
    ...
    builder.setSpout("custom-spout", new UnserializableCustomSpout(inputObjects), 1);
    builder.setBolt("check-bolt", new UnserializableCustomCheckBolt(inputObjects), 1)
