...
class HeronExecutorTest(unittest.TestCase):
  ...
  def get_shell_command_expected(container_id):
  ...
  expected_processes_container_0 = [
      ProcessInfo(MockPOpen(), 'heron-shell-0', get_shell_command_expected(0)),
  ...
  expected_processes_container_1 = [
      ...
      ProcessInfo(MockPOpen(), 'heron-shell-1', get_shell_command_expected(1)),
  ...
  expected_processes_container_7 = [
      ...
      ProcessInfo(MockPOpen(), 'heron-shell-7', get_shell_command_expected(7)),
  ]
