...
public class HPCSchedulerTest {
  private static final String HPC_PATH = "path.heron";
  private static final String HPC_ID_FILE = "hpc_job.id";
  ...
  private static HPCScheduler scheduler;
  ...
  public void testOnSchedule() throws Exception {
    HPCController controller = Mockito.mock(HPCController.class);
    ...
    PowerMockito.doReturn(WORKING_DIRECTORY).when(HPCContext.class, "workingDirectory",
        config);
  ...
  public void testOnKill() throws Exception {
    HPCController controller = Mockito.mock(HPCController.class);
    Mockito.doReturn(controller).when(scheduler).getController();
    Mockito.doReturn(HPC_ID_FILE).when(scheduler).getJobIdFilePath();
