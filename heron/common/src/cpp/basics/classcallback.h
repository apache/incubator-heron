...
{
 public:
  ClassCallBack_0(bool persist, C* c, void(C::*cb)())
    : CallBack(persist) {
    c_ = c;
    cb_ = cb;
  }
...
{
 public:
  ClassCallBack_1(bool persist, C* c, void(C::*cb)(D), D d)
    : CallBack(persist) {
    c_ = c;
    cb_ = cb;
    d_ = d;
...
{
 public:
  ClassCallBack_2(bool persist, C* c, void(C::*cb)(D, E), D d, E e)
    : CallBack(persist) {
    c_ = c;
    cb_ = cb;
    d_ = d;
...
{
 public:
  ClassCallBack_3(bool persist, C* c, void(C::*cb)(D, E, F), D d, E e, F f)
    : CallBack(persist) {
    c_ = c;
    cb_ = cb;
    d_ = d;
