...
const std::string&
ExecutableMetadata::instance() const
{
  return instance_;
}
...
const std::string&
ExecutableMetadata::package() const
{
  return package_;
}
...
const std::string&
ExecutableMetadata::version() const
{
  return version_;
}
...
const std::string&
ExecutableMetadata::majorVersion() const
{
  return major_;
}
...
const std::string&
ExecutableMetadata::minorVersion() const
{
  return minor_;
}
...
const std::string&
ExecutableMetadata::patchNumber() const
{
  return patch_;
}
...
const std::string&
ExecutableMetadata::compileUser() const
{
  return compile_user_;
}
...
const std::string&
ExecutableMetadata::compileHost() const
{
  return compile_host_;
}
...
const std::string&
ExecutableMetadata::compileTime() const
{
...
const std::string&
ExecutableMetadata::gitSha() const
{
  return git_sha_;
}
...
const std::string&
ExecutableMetadata::gitBranch() const
{
  return git_branch_;
}
...
const std::time_t&
ExecutableMetadata::startTime() const
{
  return start_time_;
}
...
const std::string&
ExecutableMetadata::logPrefix() const
{
  return log_prefix_;
}
...
const std::string&
ExecutableMetadata::logDirectory() const
{
...
bool
ExecutableMetadata::unitTest() const
{
  return unit_test_;
}

ExecutableMetadata&
ExecutableMetadata::setUnitTest(const bool unit_test)
{
