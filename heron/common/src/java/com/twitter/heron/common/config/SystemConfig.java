...
public class SystemConfig {
  ...
  /**
   * The size of packets read from socket will be determined by the minimal of: (a) time based (b) size based
  ...
  /**
   * The size of packets written to socket will be determined by the minimal of: (a) time based (b) size based
