...
def _set(cl_args):
  ...
  if cliconfig.is_valid_property(prop):
    ...
    print(f"Updated property [{prop}] for cluster {cluster}")
  else:
    print(f"Error: Unknown property [{prop}] for cluster {cluster}")
...
def _unset(cl_args):
  ...
  if cliconfig.is_valid_property(prop):
    ...
    print(f"Cleared property [{prop}] for cluster {cluster}")
  else:
    print(f"Error: Unknown property [{prop}] for cluster {cluster}")
