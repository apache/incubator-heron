...
public class MetricsCacheManagerHttpServer {
  ...
  public MetricsCacheManagerHttpServer(MetricsCache cache) throws IOException {
    metricsCache = cache;
  ...
  public class HandleStatsRequest implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
      ...
      TopologyMaster.MetricRequest req = null;
      try {
        req = TopologyMaster.MetricRequest.parseFrom(pb);
      } catch (Exception e) {
        LOG.severe("Unable to decipher post datapointList specified in StatsRequest");
