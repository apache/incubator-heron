...
trait Streamlet[R] {
  ...
  /**
    ...
    */
  def flatMap[T](
                  flatMapFn: SerializableFunction[R, _ <: java.lang.Iterable[_ <: T]])
  : Streamlet[T]
  ...
  /**
    ...
    */
  def filter(filterFn: SerializablePredicate[R]): Streamlet[R]
  ...
  def repartition(
                   numPartitions: Int,
                   partitionFn: SerializableBiFunction[R, Integer, List[Integer]])
  : Streamlet[R]
  ...
  /**
    ...
    */
  def clone(numClones: Int): List[Streamlet[R]]
  ...
  def join[K, S, T](other: Streamlet[S],
                    thisKeyExtractor: SerializableFunction[R, K],
                    otherKeyExtractor: SerializableFunction[S, K],
                    windowCfg: WindowConfig,
                    joinFunction: SerializableBiFunction[R, S, _ <: T])
  ...
  /**
    ...
    */
  def reduceByKeyAndWindow[K, V](keyExtractor: SerializableFunction[R, K],
                                 valueExtractor: SerializableFunction[R, V],
                                 windowCfg: WindowConfig,
                                 reduceFn: SerializableBinaryOperator[V])
  : Streamlet[KeyValue[KeyedWindow[K], V]]
  ...
  def reduceByKeyAndWindow[K, T](
                                  keyExtractor: SerializableFunction[R, K],
                                  windowCfg: WindowConfig,
                                  identity: T,
                                  reduceFn: SerializableBiFunction[T, R, _ <: T])
  : Streamlet[KeyValue[KeyedWindow[K], T]]
  ...
  /**
    ...
    */
  def transform[T](serializableTransformer: SerializableTransformer[R, _ <: T])
  : Streamlet[T]
  ...
  /**
    ...
    * of this streamlet.
    */
  def consume(consumer: SerializableConsumer[R]): Unit
