...
///////////////////////////// DummyTMasterClient ///////////////////////////////////////////
DummyTMasterClient::DummyTMasterClient(EventLoopImpl* eventLoop, const NetworkOptions& _options,
  ...
  Client(eventLoop, _options), stmgr_id_(stmgr_id), stmgr_host_(stmgr_host),
  stmgr_port_(stmgr_port), shell_port_(shell_port), instances_(_instances)
{
...
void
DummyTMasterClient::HandleRegisterResponse(void*,
...
void
DummyTMasterClient::HandleConnect(NetworkErrorCode _status)
{
  if (_status == OK) {
...
void
DummyTMasterClient::HandleClose(NetworkErrorCode)
{
}

void
DummyTMasterClient::CreateAndSendRegisterRequest()
{
...
///////////////////////////// DummyStMgr /////////////////////////////////////////////////
DummyStMgr::DummyStMgr(EventLoopImpl* ss, const NetworkOptions& options,
                       const sp_string& stmgr_id, const sp_string& stmgr_host,
  ...
  : Server(ss, options), num_start_bp_(0), num_stop_bp_(0)
{
  ...
  tmaster_client_ =
    new DummyTMasterClient(ss, tmaster_options, stmgr_id,
                           stmgr_host, stmgr_port, shell_port,
                           _instances);
...
void
DummyStMgr::HandleNewConnection(Connection*)
{
}

void
DummyStMgr::HandleConnectionClose(Connection*,
                                  NetworkErrorCode)
{
}

void
DummyStMgr::HandleStMgrHelloRequest(REQID _id, Connection* _conn,
...
void
DummyStMgr::HandleTupleStreamMessage(Connection*,
                                     heron::proto::stmgr::TupleStreamMessage*)
{
}

void
DummyStMgr::HandleStartBackPressureMessage(Connection*,
...
void
DummyStMgr::HandleStopBackPressureMessage(Connection*,
