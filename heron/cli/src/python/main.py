...
import heron.cli.src.python.help as heron_help
...
def create_parser():
    ...
    heron_help.create_parser(subparsers)
...
def run(command, parser, command_args, unknown_args):
    ...
    return_val = 1
    if command == 'activate':
        return_val = activate.run(command, parser, command_args, unknown_args)

    elif command == 'deactivate':
        return_val = deactivate.run(command, parser, command_args, unknown_args)

    elif command == 'kill':
        return_val = kill.run(command, parser, command_args, unknown_args)

    elif command == 'restart':
        return_val = restart.run(command, parser, command_args, unknown_args)

    elif command == 'submit':
        return_val = submit.run(command, parser, command_args, unknown_args)

    elif command == 'help':
        return_val = heron_help.run(command, parser, command_args, unknown_args)

    elif command == 'version':
        return_val = version.run(command, parser, command_args, unknown_args)
