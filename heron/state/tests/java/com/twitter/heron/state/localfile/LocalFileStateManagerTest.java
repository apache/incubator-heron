...
/**
 * LocalFileStateManager Tester.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest(FileUtility.class)
public class LocalFileStateManagerTest {
  ...
  public Map<Object, Object> getConf() {
    ...
    conf.put(LocalFileStateManager.IS_INITIALIZE_FILE_TREE, false);
    return conf;
  }

  @Test
  public void testInitialize() throws Exception {
    LocalFileStateManager manager =
        Mockito.spy(new LocalFileStateManager());
