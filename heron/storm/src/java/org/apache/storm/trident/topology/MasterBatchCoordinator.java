...
@SuppressWarnings({"unchecked", "rawtypes", "cast", "serial", "checkstyle:all"})
...
//    public static final Logger LOG = LoggerFactory.getLogger(MasterBatchCoordinator.class);
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        // only heron-specifc change in this class to use TypeUtils
        Number active = TypeUtils.getInteger(conf.get(Config.TOPOLOGY_MAX_SPOUT_PENDING));
        if(active==null) {
