...
@SuppressWarnings({"unchecked", "rawtypes", "serial", "cast"})
public class TridentBoltExecutor implements IRichBolt {
    ...
    public void prepare(Map conf, TopologyContext context, OutputCollector collector) {
        _messageTimeoutMs = 30000; // TODO support this context.maxTopologyMessageTimeout() * 1000L;
        ...
        if(_coordConditions==null) {
            ...
            for(String batchGroup: _coordSpecs.keySet()) {
                ...
                // get all downstream consumers of this component of the the stream COORD_STREAM(batchGroup)
    ...
    public void execute(Tuple tuple) {
        ...
        String batchGroup = _batchGroupIds.get(new GlobalStreamId(tuple.getSourceComponent(), tuple.getSourceStreamId()));
        if(batchGroup==null) {
...
//        }
    ...
    private TupleType getTupleType(Tuple tuple, TrackedBatch batch) {
        ...
        if(cond.commitStream!=null
                && new GlobalStreamId(tuple.getSourceComponent(), tuple.getSourceStreamId()).equals(cond.commitStream)) {
