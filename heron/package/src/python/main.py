...
def create_parser():
  ...
  # TODO(nlu): format the usage information and help message align with the heron-cli
  ...
  list_packages_parser.add_argument('--%s' % constants.RAW, dest=constants.RAW, default = False, type=bool, help='print the result in raw format')
  ...
  list_versions_parser.add_argument('--%s' % constants.RAW, dest=constants.RAW, default = False, type=bool, help='print the result in raw format')
  ...
  show_version_parser.add_argument('--%s' % constants.RAW, dest=constants.RAW, default = False, type=bool, help='print the result in raw format')
  ...
  show_live_parser.add_argument('--%s' % constants.RAW, dest=constants.RAW, default = False, type=bool, help='print the result in raw format')
  ...
  show_latest_parser.add_argument('--%s' % constants.RAW, dest=constants.RAW, default = False, type=bool, help='print the result in raw format')
  ...
  # TODO (nlu): add a purge/clean cmd to clean the package management system
...
# TODO (nlu): create blobstore according to config
def get_blobstore(conf):
  return blobstore.LocalBlobstore()

# TODO (nlu): create metastore according to config
def get_metastore(conf):
  return metastore.LocalMetastore()
...
def main():
  ...
  blobstore = get_blobstore("TODO_USE_CONFIG_FILE")
  metastore = get_metastore("TOO_USE_CONFIG_FILE")
  packer = package.HeronPackage(metastore, blobstore)
