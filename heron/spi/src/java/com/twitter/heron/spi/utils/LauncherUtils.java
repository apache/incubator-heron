...
public class LauncherUtils {
  ...
  public static PackingPlan createPackingPlan(final Config config, final Config runtime) {
    return getInstance()._createPackingPlan(config, runtime);
  }
  ...
  public static IScheduler getSchedulerInstance(
      ...
      Config runtime,
      PackingPlan packing) {
    return getInstance()._getSchedulerInstance(config, runtime, packing);
  }
  ...
  private static LauncherUtils getInstance() {
    return instance;
  }
   ...
   * @return initialized scheduler instances
   */
  private IScheduler _getSchedulerInstance(
      Config config,
      Config runtime,
      PackingPlan packing) {
   ...
   */
  public PackingPlan _createPackingPlan(final Config config, final Config runtime) {
