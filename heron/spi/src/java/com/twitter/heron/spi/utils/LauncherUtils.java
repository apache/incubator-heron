...
public final class LauncherUtils {
  ...
  private static LauncherUtilImpl instance = new LauncherUtilImpl();
  ...
  public static PackingPlan createPackingPlan(final Config config, final Config runtime) {
    return getImpl().createPackingPlan(config, runtime);
  }
   ...
   */
  public static IScheduler getSchedulerInstance(Config config, Config runtime) {
    return getImpl().getSchedulerInstance(config, runtime);
  }
   ...
   */
  public static Config createConfigWithPackingDetails(Config runtime, PackingPlan packing) {
    Config ytruntime;
  ...
  private static LauncherUtilImpl getImpl() {
    return instance;
  }
   ...
   */
  public static void setInstance(LauncherUtilImpl instance) {
    LauncherUtils.instance = instance;
  }

  /**
   * Implementation of utility methods provided by {@link LauncherUtils}. The instance of this
   * class are primarily used for mocking and testing.
   */
  public static class LauncherUtilImpl {
    private IScheduler getSchedulerInstance(Config config, Config runtime) {
