$(document).ready(function(){var e=window.localStorage,l=e["sidebar-selected"]||null;if(null!=l){var n="#collapse-"+l;$(n).collapse("show"),$(n).on("hide.bs.collapse",function(){e["sidebar-selected"]=null})}$(".panel-heading").click(function(){e["sidebar-selected"]=this.id})});
