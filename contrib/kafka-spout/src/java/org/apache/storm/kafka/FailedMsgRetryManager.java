...
public interface FailedMsgRetryManager extends Serializable {
   ...
   * Initialization
   */
  void prepare(SpoutConfig spoutConfig, Map<String, Object> stormConf);
  ...
  /**
   * The offset of message, which is to be re-emitted. Spout will fetch messages starting from this
   * offset and resend them, except completed messages.
   * @return
   */
