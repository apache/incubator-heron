...
public class Partition implements ISpoutPartition, Serializable {
  ...
  private static final long serialVersionUID = -2736013313278877399L;
  public Broker host;
  ...
  public Partition(Broker host, String topic,
                   int partition, Boolean bUseTopicNameForPartitionPathId) {
    this.topic = topic;
    this.host = host;
    this.partition = partition;
  ...
  public String toString() {
    return "Partition{ host=" + host + ", topic=" + topic + ", partition=" + partition + '}';
  }
  ...
  public String getId() {
    if (bUseTopicNameForPartitionPathId) {
      ...
      //Keep the Partition Id backward compatible with Old implementation of
      // Partition.getId() == "partition_" + partition
