...
public class DynamicBrokersReader {
    ...
    //TODO: more graceful/flexible setting up ZK connection settings
    private static final Integer STORM_ZOOKEEPER_SESSION_TIMEOUT = 30000;
    private static final Integer STORM_ZOOKEEPER_CONNECTION_TIMEOUT= 30000;
    private static final Integer STORM_ZOOKEEPER_RETRY_TIMES = 3;
    private static final Integer STORM_ZOOKEEPER_RETRY_INTERVAL = 10000;
    ...
    public DynamicBrokersReader(Map conf, String zkStr, String zkPath, String topic) {
        ...
        try {
            _curator = CuratorFrameworkFactory.newClient(
                    ...
                    new RetryNTimes(STORM_ZOOKEEPER_RETRY_TIMES,
    ...
    private void validateConfig(final Map conf) {
        // The validation below checks config for ZK connection settings.
        // Currently Heron seems to be compatible with earlier Storm version, where there weren't such properties
        // in the config, so commenting out for now.
